// Preserved elearning database mapping. The host injects its authenticated client.
...
export function createElearningPetRepository(supabase: PetDatabaseClient): PetRepository {
  return {
